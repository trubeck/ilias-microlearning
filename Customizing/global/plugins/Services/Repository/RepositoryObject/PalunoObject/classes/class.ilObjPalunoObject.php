...
require_once("./Customizing/global/plugins/Services/Repository/RepositoryObject/PalunoObject/classes/class.ilObjPalunoObjectGUI.php");
...
class ilObjPalunoObject extends ilObjectPlugin implements ilLPStatusPluginInterface
{
	...
	function doCreate()
	{
		...
		$ilDB->manipulate("INSERT INTO rep_robj_xpal_data ".
	...
	function doRead()
	{
		...
		$set = $ilDB->query("SELECT * FROM rep_robj_xpal_data ".
	...
	function doUpdate()
	{
		...
		$ilDB->manipulate($up = "UPDATE rep_robj_xpal_data SET ".
	...
	public function getLPStatusForUser($a_user_id) {
		...
		if($ilUser->getId() == $a_user_id)
			return $_SESSION[ilObjPalunoObjectGUI::LP_SESSION_ID];
		else
